    ...
    <div className="p-6 bg-gray-100 min-h-screen ml-12">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold ml-4">
          Dossier Client / <span className="text-xl">Détails</span>
        </h1>
      </div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
        ...
        <div className="ml-4 mb-4">
          <div>
            ...
            {clientFile.commune.name}
          </div>
          <div>
            <strong className="block text-gray-700">Caidat:</strong>{" "}
            {clientFile.commune.caidat.name}
          </div>
          <div>
            <strong className="block text-gray-700">Cercle:</strong>{" "}
            {clientFile.commune.caidat.cercle.name}
          </div>
          <div>
            <strong className="block text-gray-700">Province:</strong>{" "}
            {clientFile.commune.caidat.cercle.province.name}
          </div>
          <div>
            <strong className="block text-gray-700">Region:</strong>{" "}
            {clientFile.commune.caidat.cercle.province.region.name}
          </div>
        </div>
      </div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
        <h3 className="text-xl font-semibold mb-4 text-indigo-600">Fichiers</h3>
        <div className="ml-4 mb-4">
          {(clientFile.media.length !== 0 && (
            <Files media={clientFile.media} />
          )) || <p>No Media</p>}
        </div>
      </div>
    </div>
