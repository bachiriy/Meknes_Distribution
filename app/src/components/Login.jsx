            ...
            <section className="bg-white">
                <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                        ...
                        <div className="hidden lg:top-56 lg:absolute lg:block lg:p-12">
                            ...
                            <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
                                Welcome to Meknes Distribution
                            </h2>

                            <p className="mt-4 leading-relaxed text-white/90">
                                A platform for storing and managing data.
                            </p>
                        </div>
                    </section>
                        ...
                        <div className="max-w-xl lg:max-w-3xl">
                            ...
                            <form onSubmit={handleLogin} className="mt-8 grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                    <button
                                        className="inline-block shrink-0 rounded-md border border-[#0a0a0a] bg-[#0a0a0a] px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-[#0a0a0a] focus:outline-none focus:ring active:text-[#0a0a0a]"
                                    >
                                        Login
                                    </button>
                                </div>
